 $(function () {
    $("#idEstamentos").change('.form-estams', function () {
        var idEst = this.value;
        //alert("Hoy de yo "+idSede);
        var idF = document.getElementById("idFacultad").value;
        var idE = document.getElementById("idEleccion").value;
        alert("Hoy de yo "+idEst + "-"+idF+"-"+idE );
