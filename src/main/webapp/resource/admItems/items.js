$(function () {
    $("#idSede").change('.form-sedes', function () {
        ...
        $.ajax({url: 'lDireccionesItem/' + idSede,
            ...
            success: function (datos) {
                ...
                html += "<option disabled selected value='' hidden>SELECCIONE UNA DIRECCION</option>";
                for (var i = 0; i < len; i++) {
    ...
    $("#dFuncional").change('.form-dFuncional', function () {
        ...
        $.ajax({url: 'lUnidadesItem/' + idDireccionFuncional,
            ...
            success: function (datos) {
                ...
                var len = datos.length;
                html += "<option disabled selected value='' hidden>SELECCIONE UNA UNIDAD</option>";
                for (var i = 0; i < len; i++) {
    ...
    $("#btnCargo").click(function (e) {
        ...
        $.post({
            ...
            success: function (res) {
                ...
                var len = res.length;
                html += "<option disabled selected value='' hidden>SELECCIONE UNA CARGO</option>";
                for (var i = 0; i < len; i++) {
    ...
    $("#btnTipoAdmin").click(function (e) {
        ...
        $.post({
            ...
            success: function (res) {
                ...
                var len = res.length;
                html += "<option disabled selected value='' hidden>SELECCIONE UNA ADMINISTRATIVO</option>";
                for (var i = 0; i < len; i++) {
    ...
    $("#btnPnlItems").click(function (e) {
        ...
        $.post({
            ...
            success: function (res) {
                ...
                var len = res.length;
                html += "<option disabled selected value='' hidden>SELECCIONE UNA ITEM</option>";
                for (var i = 0; i < len; i++) {
    ...
    $("#btnInstitucion").click(function (e) {
        ...
        $.post({
            ...
            success: function (res) {
                ...
                var len = res.length;
                html += "<option disabled selected value='' hidden>SELECCIONE UNA INSTITUCION</option>";
                for (var i = 0; i < len; i++) {
    ...
    $("#btnSedes").click(function (e) {
        ...
        $.post({
            ...
            success: function (res) {
                ...
                var len = res.length;
                html += "<option disabled selected value='' hidden>SELECCIONE UNA SEDE</option>";
                for (var i = 0; i < len; i++) {
