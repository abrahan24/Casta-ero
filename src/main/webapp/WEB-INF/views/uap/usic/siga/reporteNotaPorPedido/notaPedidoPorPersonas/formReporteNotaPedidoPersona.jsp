        ...
        <tr><td width="100%"><br><br>
                <table border="0" width="100%" cellspacing="0" cellpadding="0">
                         <tr>
                            ...
                            <td width="1%">::</td>
                            <td width="35%"><font face="sans-serif"> ${bPersonalAdministrativo.personas.nombres} ${bPersonalAdministrativo.personas.paterno} ${bPersonalAdministrativo.personas.materno}</font></td>
                         ...
                         <tr>
                            ...
                            <th width="14%" align="left"><font face="sans-serif"></font></th> 
                            <td width="1%"></td>
                            <td width="35%"><font face="sans-serif"></font></td>
                         </tr>
                </table> 
          </td>
        </tr>
         ...
         <tr><td align="center"><br><br>
             <table width="90%" border="1" cellspacing="0" cellpadding="0">
                <tr align="center" valign="middle">
                    <th colspan="3"><spring:message code="report.noteOrder.people.detail.msg"/></th>
                </tr>
                <tr><th><font face="sans-serif"><spring:message  code="report.noteOrder.description"/></font></th>
                   
                    <th><font face="sans-serif"><spring:message  code="report.noteOrder.date"/></font></th>
                </tr>
              ...
              <c:forEach items="${lGastosPersonas}" var="gp">
                ...
                <tr>
                  <td><font face="sans-serif">${gp.descripcion}</font></td>
                   <td><font face="sans-serif"><fmt:formatDate type="date" value="${gp.fecGasto}"/></font></td>
                </tr>
              </c:forEach>
            </table>
          </td>
