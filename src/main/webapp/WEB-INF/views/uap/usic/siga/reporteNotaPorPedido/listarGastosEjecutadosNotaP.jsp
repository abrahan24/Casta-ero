    ...
    <section class="content-header">
        ...
        <div class="row">
            <div c class="col-md-02 mb-3">
                    <p><a  class="btn btn-primary" href="formReporteNotaPedido"   action="${cjaIng}" id="show"><i class="fa fa-arrow-left" aria-hidden="true"></i> Volver</a></p>
            </div>
...
<section> 
     ...
     <br>
        <center>
            <p class="h3"><i class="fa fa-list-alt" aria-hidden="true"></i>  <spring:message  code="report.noteOrder.title"/></p>
        </center>
        <br>
        <table id="tGastosReporte"  class="table" style="width:100%">
              ...
              <tbody>
                ...
                <c:forEach items="${lGastosE}" var="cge">
                    ...
                    <td><center>
                        <form modelAttribute="cjaGastosEjecutados"  action="${listarNotaPedido}" method="post"  target="blank">
