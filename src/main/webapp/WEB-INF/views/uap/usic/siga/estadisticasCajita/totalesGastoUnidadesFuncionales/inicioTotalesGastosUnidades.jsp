            ...
            <c:choose>
                <c:when test="${operation eq 'list' }">
                    <div class="col-md-02 mb-3">
                        <p><a  class="btn btn-primary" href="inicioGastosUnidad"   id="show"><i class="fa fa-arrow-left" aria-hidden="true"></i> Volver</a></p>
                    </div>
                </c:when>
            </c:choose>
            <div class="col-md-10 mb-3">
                <p class="h1"><i class="fa fa-money" aria-hidden="true"></i> <spring:message  code="totals.unit.expenses.title"/> </p>
            </div>
        </div>
    ...
    <section> 
        ...
        <c:choose>
            <c:when test="${operation eq 'form' }">
                <center> <p class="h3"><i class="fa fa-th" aria-hidden="true"></i>  <spring:message  code="totals.unit.expenses.menu"/></p> </center>
                <br>
                <form action="${urlI}" method="post" >
                    ...
                    <div class="form-group row mt-12">
                        ...
                        <div class="col-sm-3" id="combo1">
                            <a href="<spring:url value="/gUnidad/inicioGastosUnidad"/>" class="btn btn-yvela-green"><i class="fa fa-undo yvela" aria-hidden="true"></i>  <spring:message  code="expenses.btn.cancel"/></a>
                        </div> 
                    </div>
                </form>
            </c:when>
