    ...
    <section class="content-header">
        <div class="row">
            <div class="col-md-10 mb-3">
                <p class="h1"><i class="fa fa-file-archive-o" aria-hidden="true"> </i><spring:message code="poais.requisito.experiencia.titulo.modulo"/> </p>
            </div>
    ...
    <section class="content-body">
        ...
        <!-- ------------------------ Fin Tabla Listar Poais ------------------------- -->
            <c:choose>
                <c:when test="${busqueda eq 'find' }">
                    <center><br>
                        <p class="h3"><i class="fa fa-folder-open-o" aria-hidden="true"></i> <spring:message  code="poais.requisito.experiencia.titulo.lista"/></p> 
                        <br>
                    </center>
                    <table id="tComprobantes"  class="table" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th><spring:message  code="poais.requisito.experiencia.campo.expe"/></th>
                                <!-- 
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${lRExperiencias}" var="lPre">
                                <c:set var="cont" value="${cont+1}" />
                                <tr>
                                    <td>${cont}</td>
                                    <td>${lPre.poaisRequisitos.poais.gestion}</td>
                                    <td>${lPre.requisitoExperiencia}</td>
                                    <!-- 
                                    <td>
                                        <form  method="post" action="${urlM}">
                                            <input type="hidden" name="idRequisitoExperiencia" value="${lPre.idRequisitoExperiencia}">
                    ...
                    <div class="modal-footer">
	                    <a href="../../../../Castanhero/poaisRequisitos/inicioRequisito" type="submit" class="btn btn-info btn-lg float-right" aria-hidden="true">
	                    Siguiente
	                    </a>
	                </div>
                    <br>
   ...
   <section>
        <c:choose>
            <c:when test="${operation eq 'reg' }">
                <center><br>
                    <p class="h3"><i class="fa fa-folder-open" aria-hidden="true"> </i> Administrar Experiencias</p> 
                    <br>
                </center>
                <form:form modelAttribute="poaisRequisitosExperiencias" action="${regPoais}" enctype="multipart/form-data" method="post">
                   <form;hidden path="PoaisRequisitos.idRequisito" value="1" />              
                    ...
                    <div class="form-group row">
                      ...
                      <div class="form-group row">
                        <label for="codigo" class="col-sm-2 col-form-label"><spring:message  code="poais.requisito.experiencia.campo.expe"/></label>
                        <label class="col-sm-1 col-form-label text-right" >  <i class="fa fa-info-circle" aria-hidden="true"></i></label>
                        <div class="col-sm-6" id="combo1"> 
                            <spring:message  code="poais.requisito.experiencia.campo.expe" var="expe"/>
                              <form:textarea name="descripcion" path="requisitoExperiencia" class="form-control form-control-lg" placeholder="${expe}" rows="3" cols="20" />
                          </div>
                        <div class="col-sm-3" id="comd"> 
                            <small id="emailHp" class="form-text text-muted">
                                <spring:message  code="poais.requisito.experiencia.campo.expe"/>
                            </small>
                            <small class="msgError">
                               <form:errors path="requisitoExperiencia" />
                            </small>
                        </div>
                    </div>
                 <div class="form-group row">
