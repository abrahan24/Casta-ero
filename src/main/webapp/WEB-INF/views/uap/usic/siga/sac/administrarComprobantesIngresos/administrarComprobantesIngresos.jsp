...
<head>
    ...
    <script src="<spring:url value="/resource/sac/admComprob/admComproIngresoss.js" />" type="text/javascript"></script>
...
<div class="container">    
    <section class="content-header">
        <div class="row">
            <div class="col-md-10 mb-3">
                <p class="h1"><i class="fa fa-file-archive-o" aria-hidden="true"> </i> <spring:message code="income.vouchers.title"/> </p>
            </div>
            <div class="col-sm-2 text-right" id="reporte">
                <c:choose>
                    <c:when test="${busqueda eq 'find' }">
                        <form  method="POST" action="${urlNCompIng}">
    ...
    <section class="content-body">
        ...
        <!--------------- Inicio registro Comprobante Ingreso -->
        <c:choose>
            <c:when test="${operation eq 'reg' }">
                <center><br>
                    <p class="h3"><i class="fa fa-folder-open" aria-hidden="true"> </i> <spring:message  code="income.vouchers.register"/></p> 
                    <br>
                </center>
                <form:form modelAttribute="sacComprobantes" action="${urlRegComIng}" enctype="multipart/form-data" method="post">
                    <input type="hidden" name="cantBenificiarios" id="cantBenif">
                    <input type="hidden" name="cantNroComprobante" id="cantNroComp">
                    <form:input type="hidden" path="hojaRuta" value="1" />
                        ...
                        <div class="col-sm-6">
                            <form:select class="form-control form-control-lg" path="SacTiposComprobantes.idSacTipoComprobante" id="tComprobante">
                                <c:forEach var="ltc" items="${requestScope.lTiposComprobantes}">
                                     <c:if  test="${ltc.idSacTipoComprobante == 1}">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-sm-1 col-form-label text-right" > <i class="fa fa-info-circle" aria-hidden="true"></i></label>
                        <div class="col-sm-6" id="combo1"> 
                            <form:input class="form-control form-control-lg" path="nombreArchivo"  id="fileName" placeholder="${adj}" />
                        </div>
                        <div class="col-sm-3" id="combo1"> 
                            <small id="emailHelp" class="form-text text-muted">
                    ...
                    <div class="form-group row mt-12">
                        ...
                        <div class="col-sm-3" id="combo1">
                            <a href="<spring:url value="/comprobanteIngresos/inicioComprobantesIngresos"/>" class="btn btn-yvela-green"><i class="fa fa-undo yvela" aria-hidden="true"></i>  <spring:message  code="expenses.btn.cancel"/></a>
                        </div> 
                    </div>
                </form:form>
                <br><br>
        ...
        <!-- Final registro comprobantes Ingresos -->

        <!--Inicio modificar Comprobantes Ingresos -->
        <c:choose>
            <c:when test="${operation eq 'edit' }">
                <center><br>
                    <p class="h3"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>  <spring:message  code="income.vouchers.modify"/></p> 
                    <br>
                </center>
                <form:form modelAttribute="sacComprobantes" action="${confCompIngresos}" enctype="multipart/form-data" method="post">
                    <input type="hidden" name="cantBenificiarios" id="cantBenif">
                    <form:input type="hidden" path="Usuarios.idUsuario" value="${currentUserId}" />
                    <form:input type="hidden" path="idSacComprobante" value="${sacComprobantes.idSacComprobante}" />
                     <form:input type="hidden" path="hojaRuta" value="${sacComprobantes.hojaRuta}" />
                    <div class="form-group row">
                        <label for="codigo" class="col-sm-2 col-form-label"><spring:message  code="manage.folders.bookcase"/></label>
                        <label class="col-sm-1 col-form-label text-right" >  </label>
                        <div class="col-sm-6">
        ...
        <!------------------------------------ Final Modificar Comprobantes Ingresos------------------------------------------- -->

        <!------------------------------------ Inicio eliminar omprobantes Ingresos------------------------------------------- -->
        <c:choose>
            <c:when test="${operation eq 'deletVoucher' }">
                <div id="" class="col-lg-12" >
                    <br>
                    <center><h5><i class="fa fa-trash-o" aria-hidden="true"></i>  <spring:message  code="income.vouchers.remove"/></h5></center>
                    <br>
                    <div class="form-group row">
                        <div class="col-sm-8" id="combo1"> 
                            <form:form modelAttribute="sacComprobantes" action="${confElimiCompIng}" enctype="multipart/form-data" method="post">
                                <form:input type="hidden" path="Usuarios.idUsuario" value="${currentUserId}" />
                                   <form:input type="hidden" path="hojaRuta" value="${sacComprobantes.hojaRuta}" />
                                <form:input type="hidden" path="idSacComprobante" value="${sacComprobantes.idSacComprobante}" />
                                <div class="form-group row">
                                ...
                                <div class="form-group row mt-12">
                                    ...
                                    <div class="col-sm-3" id="combo1">
                                        <span class="icon-input-btn"><i class="fa fa-times yvela" aria-hidden="true"></i> 
                                            ...
                                            <div class="col-sm-3" id="combo1"> 
                                                <a href="<spring:url value="/comprobanteIngresos/inicioComprobantesIngresos"/>" class="btn btn-yvela-green"><i class="fa fa-undo" aria-hidden="true"></i>  <spring:message  code="expenses.btn.cancel"/></a>
                                            </div>
                                    </div>
                                </form:form>
                            </div>
            ...
            <!------------------------------------ Final Eliminar Comprobantes Ingresos------------------------------------------- -->

            <!--Tabla lista de Todos los Comprobantes-Ingresos Registrados -->
            <c:choose>
                <c:when test="${busqueda eq 'find' }">
                    <center><br>
                        <p class="h3"><i class="fa fa-folder-open-o" aria-hidden="true"></i> <spring:message  code="income.vouchers.list"/></p> 
                        <br>
                    </center>
                    <table id="tComprobantes"  class="table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${lComprobantes}" var="lSac">
                                <c:if  test="${lSac.sacTiposComprobantes.idSacTipoComprobante == 1}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form  method="post" action="${urlMIng}">
                                                <input type="hidden" name="idSacComprobante" value="${lSac.idSacComprobante}">
                                                <span class="icon-input-btn"> <i class="fa fa-pencil-square-o yvela" aria-hidden="true"> </i> <input class="btn btn-success" type="submit"  value="<spring:message  code="expenses.modify"/>" > </span>
                                            </form>
                                        </td>
                                        <td>
                                            <form name="Delet" action="${urlDIngre}" method="post">
                                                <input type="hidden" name="idSacComprobante" value="${lSac.idSacComprobante}">
