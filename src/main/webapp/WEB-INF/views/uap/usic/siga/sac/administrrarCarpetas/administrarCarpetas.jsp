...
<div class="container">    <section class="content-header">
        <div class="row">
            <div class="col-md-10 mb-3">
                <p class="h1"><i class="fa fa-folder-o" aria-hidden="true"></i> <spring:message code="manage.folders.title"/> </p>
            </div>
            <div class="col-sm-2 text-right" id="reporte">
                <c:choose>
                    <c:when test="${busqueda eq 'find' }">
                        <form  method="POST" action="${urlNCar}">
    ...
    <section class="content-body">
        ...
        <c:choose>
            <c:when test="${operation eq 'reg' }">
                ...
                <form:form modelAttribute="sacCarpetas" action="${regCarpetas}" method="post">
        ...
        <c:choose>
            <c:when test="${busqueda eq 'find' }">
                ...
                <center><br>
                    <p class="h3"><i class="fa fa-folder-open-o" aria-hidden="true"></i> <spring:message  code="manage.folders.detail"/></p> 
                    <br>
                </center>
