...
<head>
    ...
    <title>Freddy FileManager</title>

    <link rel="stylesheet" type="text/css" href="/resource/RichFilemanager/src/css/libs-main.css" />
    <link rel="stylesheet" type="text/css" href="/resource/RichFilemanager/src/css/filemanager.min.css" />
...
<div class="fm-container">
    ...
    <div class="fm-wrapper">
        <div class="fm-header">
            <div class="breadcrumbs">
                ...
                <div data-bind="foreach: {data: breadcrumbsModel.items, as: 'bcItem'}">
                    ...
                    <!-- ko if: !bcItem.active -->
                    <div class="separator">&gt TODO;</div>
                    <!-- /ko -->
                </div>
            </div>
        ...
        <script type="text/javascript" src="/resource/RichFilemanager/src/js/libs-main.js"></script>
        <script type="text/javascript" src="/resource/RichFilemanager/src/js/filemanager.min.js"></script>
        <script type="text/javascript" src="/resource/RichFilemanager/config/filemanager.init.js"></script>
