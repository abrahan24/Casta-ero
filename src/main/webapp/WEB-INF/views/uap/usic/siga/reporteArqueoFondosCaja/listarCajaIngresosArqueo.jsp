...
<div class="container">
    <section class="content-header">
        <div class="row">
            <div class="col-md-10 mb-3">
                <p class="h1"> <i class="fa fa-money" aria-hidden="true"></i> <spring:message code="report.arching.title"/></p>
            </div>
    ...
    <section> 
        ...
        <br>
       <form:form modelAttribute="cjaGastosEjecutado" action="${repArqueoCaja}" method="post" target="blank">
        <table class="table">
            <tr class="trIngreso">
                      <th align="center"> ? </th>
