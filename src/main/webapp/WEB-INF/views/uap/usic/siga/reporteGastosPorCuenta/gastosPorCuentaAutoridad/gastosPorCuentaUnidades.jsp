...
<head>
    ...
    <script src="<spring:url value="/resource/admReportes/reportesAutoridad/reportesGastosCuentaAutoridad.js" />" type="text/javascript"></script>
...
<div class="container">
        ...
        <div class="row">
         <c:choose>
            ...
            <div class="col-md-02 mb-3">
                <p><a  class="btn btn-primary" href="formGastosPorCuentasAutoridad"   id="show"><i class="fa fa-arrow-left" aria-hidden="true"></i> Volver</a></p>
            </div>
            </c:when>
         </c:choose>
            
            <div class="col-md-10 mb-3">
                <p class="h1"><i class="fa fa-money" aria-hidden="true"></i> <spring:message  code="report.account.expenses.unity.menu"/> </p>
            </div>
    ...
    <section> 
        ...
        <br>
        <!----------------Formulario Reporte Gastos por Cuenta Unidades-Autoridad======================================================== -->
        <spring:url var="formUrl" value="signupsss" />    
        <c:choose>
            <c:when test="${operation eq 'form' }">

                <center> <p class="h3"><i class="fa fa-th" aria-hidden="true"></i>  <spring:message  code="report.account.expenses.unity.detail"/></p> </center>
                <br>
                <form action="${lCjaIngCuenta}" method="post" >
        ...
        <c:choose>
            <c:when test="${operation eq 'unidad' }">
                ...
                <br>
                <form:form modelAttribute="cjaGastosEjecutado" action="${mostrarReporteCuentaAut}" method="post" target="blank">
                    <table class="table">
                        <tr class="trIngreso">
                            <th align="center"> ? </th>
