            ...
            <tbody>
                <tr><td align="center"><br><br>
                        <table width="90%" border="1" cellspacing="0" cellpadding="0">
                            <tr align="center" valign="middle">
                                <th colspan="6"><spring:message code="report.account.detail"/></th>
                            </tr>
                            <tr>
                ...
                <c:forEach items="${lGastosA}" var="tc">
                    ...
                    <tr>
                        ...
                        <td><center><center><fmt:formatDate type="date" value="${tc.fecGasto}"/></center></center></td>
                        <td>${tc.descripcion}</td>
                        <td><center>${tc.nroFactura}</center></td>
                        <td><center>${tc.totalG}</center></td>
                    </tr>
