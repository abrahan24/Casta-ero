...
<div class="container">      <section class="content-header">
        <div class="row">
            <div class="col-md-10 mb-3">
                 <p class="h1"> <i class="fa fa-money" aria-hidden="true"></i> <spring:message  code="sufragio.titulo.modulo.frentes"/> </p>
            </div>
    ...
    <section>
     <c:choose>
    	 ...
    	 <center>
        <p class="h3"><i class="fa fa-list-alt" aria-hidden="true"></i> <spring:message  code="sufragio.titulo.form.frente"/> </p> 
    </center>
    <br>
     <table class="table">
                <thead>
                    <tr class="trIngreso">
                      ...
                      <th><spring:message  code="sufragio.form.campo.frente"/></th>
                      <th><spring:message  code="sufragio.form.campo.integrantes"/></th>
                    </tr>
                  </thead>
                  <tbody>
                  <c:forEach var="lmh" items="${requestScope.lFrentes}">
                    <tr id="thing">
     ...
     <!--  ========= Inicio de Formulario Administrar Frentes  ==================== -->
      ...
      <c:choose>
            <c:when test="${operation eq 'reg' }">
                <center><br>
                    <p class="h3"><i class="fa fa-newspaper-o" aria-hidden="true"> </i> <spring:message  code="sufragio.titulo.form.registro.frente"/> </p> 
                    <br>
                     </center>
                <spring:url var="formUrl" value="signupsss" />
                <form:form  modelAttribute="escFrentes" action="${urlreg}" method="post" >
                   ...
                   <div class="form-group row">
                        <label for="codigo" class="col-sm-2 col-form-label"><spring:message  code="sufragio.form.campo.frente"/> </label>
                        <label class="col-sm-1 col-form-label text-right" >  <i class="fa fa-info-circle" aria-hidden="true"></i></label>
                        <div class="col-sm-6">
                            <spring:message  code="sufragio.form.frente.obs" var="frnt"/>
                              <form:input  path="frente"  class="form-control form-control-lg"  placeholder="${frnt}"/>
                        </div>
                        <div class="col-sm-3" id="comd">
                            <small class="form-text text-muted">
                             <spring:message  code="sufragio.form.frente.obs"/>
                            </small>
                            <small class="msgError">
                                <form:errors path="frente" />
                            </small>
                        </div>
                    </div>
                      <div class="form-group row">
                        <label for="codigo" class="col-sm-2 col-form-label"><spring:message  code="sufragio.form.campo.sigla"/></label>
                        <label class="col-sm-1 col-form-label text-right" >  <i class="fa fa-info-circle" aria-hidden="true"></i></label>
                        <div class="col-sm-6">
                            <spring:message  code="sufragio.form.sigla.obs" var="sig"/>
                              <form:input  path="sigla"  class="form-control form-control-lg"  placeholder="${sig}"/>
                        </div>
                        <div class="col-sm-3" id="comd">
                            <small class="form-text text-muted">
                              <spring:message  code="sufragio.form.sigla.obs"/>
                            </small>
                            <small class="msgError">
                         ...
                         <div class="form-group row">
                        <label for="codigo" class="col-sm-2 col-form-label"><spring:message  code="sufragio.form.campo.integrantes"/> </label>
                        <label class="col-sm-1 col-form-label text-right" >  <i class="fa fa-info-circle" aria-hidden="true"></i></label>
                        <div class="col-sm-6">
                            <spring:message  code="sufragio.form.integrantes.obs" var="nint"/>
                              <form:input  path="nroIntegrantes"  class="form-control form-control-lg"  placeholder="${nint}"/>
                        </div>
                        <div class="col-sm-3" id="comd">
                            <small class="form-text text-muted">
                                <spring:message  code="sufragio.form.integrantes.obs"/>
                            </small>
                            <small class="msgError">
                                <form:errors path="nroIntegrantes" />
                            </small>
                        </div>
                       </div>
                    <div class="form-group row">
