    ...
    <section class="content-header">
        <div class="row">
            <div class="col-md-10 mb-3">
                <p class="h1"><i class="fa fa-file-archive-o" aria-hidden="true"> </i><spring:message code="poais.requisito.formacion.titulo.modulo"/> </p>
            </div>
    ...
    <section class="content-body">
        ...
        <!-- ------------------------ Fin Tabla Listar Poais ------------------------- -->
            <c:choose>
                <c:when test="${busqueda eq 'find' }">
                    <center><br>
                        <p class="h3"><i class="fa fa-folder-open-o" aria-hidden="true"></i> <spring:message  code="poais.requisito.formacion.titulo.lista"/></p> 
                        <br>
                    </center>
                    <table id="tComprobantes"  class="table" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th><spring:message  code="poais.requisito.formacion.campo.forma"/></th>
                                <!-- 
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${lRFormaciones}" var="lPrf">
                                <c:set var="cont" value="${cont+1}" />
                                <tr>
                                    <td>${cont}</td>
                                    <td>${lPrf.poaisRequisitos.poais.gestion}</td>
                                    <td>${lPrf.requisitoFormacion}</td>
                                    <!-- 
                                    <td>
                                        <form  method="post" action="${urlM}">
                                            <input type="hidden" name="idRequisitoFormacion" value="${lPrf.idRequisitoFormacion}">
                    ...
                    <div class="modal-footer">
	                    <a href="../../../../Castanhero/poaReqExperiencias/inicioReqExperiencia" type="submit" class="btn btn-info btn-lg float-right" aria-hidden="true">
	                    Siguiente
	                    </a>
	                </div>
                    <br>
   ...
   <section>
        <c:choose>
            <c:when test="${operation eq 'reg' }">
                <center><br>
                    <p class="h3"><i class="fa fa-folder-open" aria-hidden="true"> </i>  <spring:message  code="poais.requisito.formacion.titulo.form"/></p> 
                    <br>
                </center>
                <form:form modelAttribute="poaisRequisitosFormaciones" action="${regPoais}" enctype="multipart/form-data" method="post">
                   <form;hidden path="PoaisRequisitos.idRequisito" value="1" />              
                    ...
                    <div class="form-group row">
                      ...
                      <div class="form-group row">
                        <label for="codigo" class="col-sm-2 col-form-label"><spring:message  code="poais.requisito.formacion.campo.forma"/></label>
                        <label class="col-sm-1 col-form-label text-right" >  <i class="fa fa-info-circle" aria-hidden="true"></i></label>
                        <div class="col-sm-6" id="combo1"> 
                            <spring:message  code="poais.requisito.formacion.msg.forma" var="forma"/>
                              <form:textarea name="descripcion" path="requisitoFormacion" class="form-control form-control-lg" placeholder="${forma}" rows="3" cols="20" />
                          </div>
                        <div class="col-sm-3" id="comd"> 
                            <small id="emailHp" class="form-text text-muted">
                                <spring:message  code="poais.requisito.formacion.msg.forma"/>
                            </small>
                            <small class="msgError">
                               <form:errors path="requisitoFormacion" />
                            </small>
                        </div>
                    </div>
                 <div class="form-group row">
