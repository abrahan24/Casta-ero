                ...
                <tr><td align="center" width="20%" ><img border="0" src="${pageContext.request.contextPath}/resource/images/logs/logouap.jpg" class="img-rounded"  class="img-responsive" alt="UAP" width="65" height="80"></td>
                     ...
                     <td width="20%" align="center"> 
                           <table border="1" width="100%" height="100%" cellspacing="0" cellpadding="0">  
                               <tr><td   align="left"><font size="1" face="sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;FORM: 005-C </font></td></tr>
        ...
        <tr><td width="100%"><br><br>
                <table border="0" width="100%" cellspacing="0" cellpadding="0">
                         <tr>
                            ...
                            <td width="1%">::</td>
                            <td width="14%"><font face="sans-serif">${bCajaIngreso.fecIngreso}</font></td>
                            <th width="35%" align="left"><font face="sans-serif"><spring:message  code="report.arching.amount"/></font></th> 
                            <td width="1%">::</td>
                            <td width="14%"><font face="sans-serif">${bCajaIngreso.monto}</font></td>
                        </tr>
                         <tr>
                         ...
                         <tr>
                            ...
                            <td width="1%">::</td>
                            <td width="14%"><font face="sans-serif">${bCajaIngreso.monto + saldoAnterior.saldo}</font></td>
                        </tr>
                </table> 
          </td>
        </tr>
         ...
         <tr><td align="center"><br><br>
             <table width="90%" border="1" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <th><center><spring:message code="report.account.account"/></center></th>
                    <th><center><spring:message code="report.account.expense"/> </center></th>
