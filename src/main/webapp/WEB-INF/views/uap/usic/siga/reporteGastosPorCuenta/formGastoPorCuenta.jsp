...
<div class="container">
    <section class="content-header">
        <div class="row">
            <div class="col-md-10 mb-3">
                <p class="h1"> <i class="fa fa-money" aria-hidden="true"></i> <spring:message code="reporte.reporteCC"/></p>
            </div>
    ...
    <section> 
        ...
        <br>
        <form:form modelAttribute="cjaGastosEjecutado" action="${repPorCuentaG}" method="post" target="blank">
          <table class="table">
                <tr class="trIngreso">
                      <th align="center"> ?  </th>
                ...
                <c:forEach items="${lIngresos}" var="li">
                    ...
                    <tr>
                      ...
                      <td>
                          <input type="date" name="fecGasto${li.idCjaIngreso}" class="form-control form-control-lg" />
