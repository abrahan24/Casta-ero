...
<head>
    ...
    <script src="<spring:url value="/resource/admReportes/reportesAutoridad/reporteArqueoGlobalAutoridad.js" />" type="text/javascript"></script>
...
<div class="container">
        ...
        <div class="row">
         <c:choose>
            ...
            <div class="col-md-02 mb-3">
                <p><a  class="btn btn-primary" href="formReporteArqueoGlobalCjaAutoridad"   id="show"><i class="fa fa-arrow-left" aria-hidden="true"></i> Volver</a></p>
            </div>
            </c:when>
         </c:choose>
            <div class="col-md-10 mb-3">
                <p class="h1"><i class="fa fa-money" aria-hidden="true"></i> <spring:message  code="report.global.tonnage.menu"/> </p>
            </div>
    ...
    <section> 
        ...
        <br>
        <!----------------Formulario Reporte Arqueo global Cuenta Unidades-Autoridad======================================================== -->
        <spring:url var="formUrl" value="signupsss" />    
        <c:choose>
            <c:when test="${operation eq 'form' }">

                <center> <p class="h3"><i class="fa fa-th" aria-hidden="true"></i>  <spring:message  code="report.global.tonnage.title"/></p> </center>
                <br>
                <form action="${lAqueoGlobalCuenta}" method="post" >
                    ...
                    <div class="form-group row mt-12">
                        ...
                        <div class="col-sm-3" id="combo1">
                            <a href="<spring:url value="/reportes/formReporteArqueoGlobalCjaAutoridad"/>" class="btn btn-yvela-green"><i class="fa fa-undo yvela" aria-hidden="true"></i>  <spring:message  code="expenses.btn.cancel"/></a>
                        </div> 
                    </div>
                </c:when>
            </c:choose>
        ...
        <c:choose>
            <c:when test="${operation eq 'unidad' }">
                ...
                <br>
                <form:form modelAttribute="cjaGastosEjecutado" action="${verRepArqGlobalAut}" method="post" target="blank">
                    <table class="table">
                        <tr class="trIngreso">
                            <th align="center"> ? </th>
                            ...
                            <th align="center"><spring:message  code="report.account.selectDate"/></th>
                        </tr>
                        ...
                        <c:forEach items="${lIngresosU}" var="li">
                            ...
                            <tr id="thing">
                                ...
                                <td><input type="date" name="fecGasto${li.idCjaIngreso}" class="form-control form-control-lg" /> 
                                    <input type="hidden" name="fecIngreso${li.idCjaIngreso}" value="${li.fecIngreso}">
