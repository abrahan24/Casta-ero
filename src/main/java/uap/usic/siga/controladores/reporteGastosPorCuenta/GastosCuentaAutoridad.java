...
public class GastosCuentaAutoridad {
    ...
    @GetMapping(value = "/formGastosPorCuentasAutoridad")
    public String gastosPorCuentasCajasAutoridad(@ModelAttribute("cjaGastosEjecutado") CjaGastosEjecutados cjaGastosEjecutado, Model model, HttpSession session) {

        model.addAttribute("operation", "form");
        getDesplegarListasComunes(model, session);
        return "gastosCuentaAutoridad";
    }

    @RequestMapping(value = "/lDireccioness/{id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public @ResponseBody
    List<InsDireccionesFuncionales> getListarDireccionesFuncionaless(@PathVariable("id") long id) {
        return iServicio.listarDireccionesFuncionalesPorIdSede(id);
    }

    @RequestMapping(value = "/lUnidadess/{id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public @ResponseBody
    List<InsUnidadesFuncionales> getListarUnidadesFuncionaless(@PathVariable("id") long id) {
        return iServicio.listarUnidadesFuncionalesPorIdDireccionFuncional(id);
    }

    @PostMapping(value = "/listarCjaIngresosCuentaAutoridad")
    ...
    @PostMapping(value = "/reporteGastoPorCuentasAutoridad")
    public String reporteGastosPorCuentaFondosAutoridad(@ModelAttribute("cjaGastosEjecutado") CjaGastosEjecutados cjaGastosEjecutaso, Model model,
        ...
        return "reportePorCuentaGastosAutoridadImp";
    ...
    public void getDesplegarListasComunes(Model model, HttpSession session) {
        ...
        model.addAttribute("lCjaIngCuenta", "listarCjaIngresosCuentaAutoridad");
        model.addAttribute("mostrarReporteCuentaAut", "reporteGastoPorCuentasAutoridad");
